...
class Database():
    ...
    def create(self):
        ...
        cursor.execute("CREATE TABLE posts(id VARCHAR(23) NOT NULL PRIMARY KEY, user_id VARCHAR(16) NOT NULL, post VARCHAR(255) NOT NULL, flags VARCHAR(10), time_posted INT NOT NULL, FOREIGN KEY (user_id) REFERENCES users (user_name));")
