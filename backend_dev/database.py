...
class Database():
    ...
    def create(self):
        ...
        cursor.execute("CREATE TABLE comments(id INT NOT NULL PRIMARY KEY, user_id VARCHAR(16) NOT NULL, post_id VARCHAR(23) NOT NULL, comment VARCHAR(255) NOT NULL, FOREIGN KEY (user_id) REFERENCES users (user_name), signature VARCHAR(344), FOREIGN KEY (post_id) REFERENCES posts (id));")
