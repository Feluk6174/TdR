...
import access_my_info, functions, search_screen, home_screen
...
class ProfileScreen (Screen):
    def __init__(self, connection, **kwargs):
        ...
        self.user_followers_following_box = BoxLayout(size_hint_y = None, height = (Window.size[1] - Window.size[0] / 5) * 0.9 / 5)
        self.content_grid.add_widget(self.user_followers_following_box)

        self.user_followers_btn = Button(text = "Followers")
        self.user_followers_following_box.add_widget(self.user_followers_btn)
        self.user_followers_btn.bind(on_release = self.user_followers_press)

        self.user_following_btn = Button(text = "Following")
        self.user_followers_following_box.add_widget(self.user_following_btn)
